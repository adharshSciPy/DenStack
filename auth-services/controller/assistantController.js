...
const forgotAssistantPassword = async (req, res) => {
  try {
...
const verifyAssistantOTP = async (req, res) => {
...
const resetAssistantPassword = async (req, res) => {
...
export {
    registerAssistant, loginAssistant, allAssistant, fetchAssistantById, fetchAssistantByUniqueId, updateAssistant, deleteAssistant, approveAssist, forgotAssistantPassword, verifyAssistantOTP, resetAssistantPassword 
}
